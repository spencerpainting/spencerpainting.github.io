						...
						<div class="6u">
							...
							<!-- Feature1 -->
								<section>
									...
									<p>New Construction, Existing Construction, Residential and Commercial. Spencer Painting offers a wide range of 
						...
						<div class="6u">
							...
							<!-- Feature2 -->
								<section>
									...
									<p>Residential, Commercial and Farms. Houses, barns, metal buildings, or just small painting jobs around the
									house, let us help you take the pain out of painting.<br><br></p>
								</section>
						...
						<div class="4u" >
							...
							<!-- Feature5 -->
								<section>
									...
									<header>
										<h3>Drywall and Plaster Repair</h3>
									</header>
...
<?php
		error_reporting(0);
          ...
          if (isset($_POST['contact_submitted'])) {
			...
			$contact_email = "Reply Email: ".$youremail;
            $message_text = "Message: ".$yourmessage;
            $user_answer = trim(htmlspecialchars($_POST['user_answer']));
            $answer = trim(htmlspecialchars($_POST['answer']));
            $message = "Message received! I will get back to you as soon as possible\r\n\r\nOriginal Message:\r\n" .$return . $contact_name . $return . $contact_email . $return . $message_text;
        ...
        <form id="contact" action="#Contact" method="post">
          <div class="form_settings">
            ...
            <p style="padding-top: 15px"><span>&nbsp;</span><input class="submit" type="submit" name="contact_submitted" value="&nbsp;&nbsp;send&nbsp;&nbsp;" /></p>
						...
						<div class="6u">
							<section>
								<p>Contact us today for more information about our services and to schedule an appointment for a free estimate.
								We can be reached by phone, mail, facebook or by filling out the form.</p>
								<div class="row">
									<div class="6u">
										<ul class="icons">
											...
											<li class="icon fa-phone"><a href="tel:+13194724569">(319) 472-4569</a></li>
											<li class="icon fa-phone"><a href="tel:+13193605046">(319) 360-5046</a> - cell
											</li>
